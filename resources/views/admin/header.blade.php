...
<body>
		<nav class="white">
				<div class="nav-wrapper">
					<a href="#" class="brand-logo center"><img src="../images/logo.png" style="height:55px;width:auto;margin-top:20px;" alt=""></a>
					...
					<ul class="side-nav" id="mobile">
						...
						<li><a href="http://localhost:8000/admin/dashboard"><i class="fa fa-home"></i> Inicio</a></li>
						<li><a id="logout"><i class="fa fa-sign-out"></i> Cerrar sesión</a></li>
						</ul>
				</div>
	</nav>
